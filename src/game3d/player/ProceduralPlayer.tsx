...
export function ProceduralPlayer({ animation, moveSpeed }: Props) {
  ...
  const materials = useMemo(() => ({
    ...
    hoodie: new THREE.MeshStandardMaterial({ color: '#3a3a48', roughness: 0.84, metalness: 0.02 }),
    hoodieInner: new THREE.MeshStandardMaterial({ color: '#2a2a36', roughness: 0.90 }),
    hoodieShadow: new THREE.MeshStandardMaterial({ color: '#2a2a38', roughness: 0.90 }),
    jeans: new THREE.MeshStandardMaterial({ color: '#3a4a6a', roughness: 0.80, metalness: 0.02 }),
    jeansFaded: new THREE.MeshStandardMaterial({ color: '#4a5a7a', roughness: 0.84 }),
    sneakers: new THREE.MeshStandardMaterial({ color: '#e8e8e8', roughness: 0.60, metalness: 0.04 }),
    sneakersSole: new THREE.MeshStandardMaterial({ color: '#333', roughness: 0.82 }),
    sneakersLaces: new THREE.MeshStandardMaterial({ color: '#f5f5f5', roughness: 0.75 }),
    backpack: new THREE.MeshStandardMaterial({ color: '#4a3d35', roughness: 0.84 }),
    backpackDark: new THREE.MeshStandardMaterial({ color: '#3a2e26', roughness: 0.88 }),
    backpackMetal: new THREE.MeshStandardMaterial({ color: '#999', roughness: 0.4, metalness: 0.55 }),
    hair: new THREE.MeshStandardMaterial({ color: '#2a1e16', roughness: 0.90 }),
